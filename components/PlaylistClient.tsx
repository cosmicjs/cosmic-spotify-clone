...
export default function PlaylistClient({ slug }: PlaylistClientProps) {
  ...
  useEffect(() => {
    async function fetchPlaylistData() {
      try {
        const playlistData = await getPlaylist(slug);
      ...
      <div className="container mx-auto p-4">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-1/3">
            <div className="animate-pulse aspect-square bg-gray-200 dark:bg-gray-700 rounded-lg"></div>
          </div>
                ...
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="h-4 w-1/4 bg-gray-200 dark:bg-gray-700 rounded mb-1"></div>
